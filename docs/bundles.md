...
```html
<!-- The everyday combo -->
<script src="https://cdn.jsdelivr.net/npm/velin/velin-common.min.js"></script>
```

```html
<!-- Compose your own: core once, then add-ons -->
<script src="https://cdn.jsdelivr.net/npm/velin/velin-core.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/velin/velin-standard.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/velin/velin-router.min.js"></script>
```

```html
<!-- Kitchen sink -->
<script src="https://cdn.jsdelivr.net/npm/velin/velin-all.min.js"></script>
```
...
are load-order side effects, not module exports. `import Velin from 'velin'`
